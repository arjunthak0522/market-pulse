const CACHE='market-pulse-v7';
const ASSETS=['./','./index.html','./styles.css?v=7','./enhancements.css?v=7','./premium.css?v=7','./app.js?v=7','./premium.js?v=7','./manifest.webmanifest?v=7','./data/market_context.json','./data/history.json'];
