const CACHE='market-pulse-v5';
const ASSETS=['./','./index.html','./styles.css?v=5','./enhancements.css?v=5','./app.js?v=5','./manifest.webmanifest?v=5','./data/market_context.json','./data/history.json'];
